...
Типы-суммы позволяют создавать типы набор полей которых может быть различен, но это не мешает им оставаться одним и тем же типом. Например тим имени можно представить как "имя + фамилия" или "имя+отчество+фамилия" или "инициалы+фамилия":
```haskell
