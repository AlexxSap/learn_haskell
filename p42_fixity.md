...
Всего существует `9` уровней приоритета операций, начиная с `0`. `0` - это самый высший приоритет и им обладает применение функции, больше ничего в него прописать нельзя. 
