...
Моноиды так же делятся на:
- коммутативные - все элементы которых можно поменять местами (`1+2==2+1`)
- некоммутативными - для которых это не выполняется (например списки `[1,2]++[3,4] != [3,4]++[1,2]`)
- дуальными - моноид с обратным порядком применения операций.
